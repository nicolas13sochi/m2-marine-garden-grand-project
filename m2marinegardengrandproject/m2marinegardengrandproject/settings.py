'''
Django settings for m2marinegardengrandproject project.
...
ROOT_URLCONF = 'm2marinegardengrandproject.urls'
...
WSGI_APPLICATION = 'm2marinegardengrandproject.wsgi.application'
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, 'm2marinegardengrandproject/static')
...
# import ENV settings
from m2marinegardengrandproject.env_settings import *
